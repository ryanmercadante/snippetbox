...
import (
	...
	"github.com/ryanmercadante/snippetbox/pkg/forms"
...
// Add a new createSnipperForm handler, which for now returns a placeholder response.
...
func (app *application) createSnippet(w http.ResponseWriter, r *http.Request) {
	...
	// and the corresponding key ("flash") to the session data. Note that if there's
	// no existing session for the current user (or their session has expired) then
	// a new, empty, session for them will automatically be created by the
	// session middleware.
...
func (app *application) signupUser(w http.ResponseWriter, r *http.Request) {
	...
	// that their signup worked and asking them to log in.
...
func (app *application) logoutUser(w http.ResponseWriter, r *http.Request) {
	...
	// Add a flash message to the session to confirm to the user that
