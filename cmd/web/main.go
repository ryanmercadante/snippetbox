...
func main() {
	...
	// will be used to encrypt and authenticate sessions cookies). It should be
	// 32 bytes long.
	...
	// passing in the secret key as the parameter. Then we configure it so sessions
	// always expires after 12 hours.
