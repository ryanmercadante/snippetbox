...
func newTemplateCache(dir string) (map[string]*template.Template, error) {
	...
	for _, page := range pages {
		// Extract the file name (line 'home.page.tmpl') from the full file path
		...
		// Use ParseGlob method to add any 'layout' templates to the
		// template set (in our case, it's just the 'base' layout at
		// the moment).
