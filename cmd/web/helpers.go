...
// to the user. We'll use this later in the book to send responses like 500 "Bad
...
func (app *application) render(w http.ResponseWriter, r *http.Request, name string, td *templateData) {
	...
	// Write the contents of the buffer to the htttp.ResponseWriter. Again,
	// this is another time where we pass our http.ResponseWriter to a function
