...
func (m *SnippetModel) Insert(title, content, expires string) (int, error) {
	...
	// for readability (which is why it's surrounded by backquotes instead
...
// Get will get a specific snippet based on its id.
func (m *SnippetModel) Get(id int) (*models.Snippet, error) {
	// Write the SQL statement we want to execute. Again, split over
...
func (m *SnippetModel) Latest() ([]*models.Snippet, error) {
  ...
  WHERE expires > UTC_TIMESTAMP() ORDER BY created DESC LIMIT 10`
	...
	// SQL statement. This returns a sql.Rows resultset containing the
	// result of our query.
	...
	// When rows.Next() loop has finished we call rows.Err() to retrieve any
